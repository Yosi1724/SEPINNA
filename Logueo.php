...
if (isset($_POST['login'])) {
	...
	if ($email == 'sepinna@gmail.com') {

		$result = "SELECT * FROM users WHERE email = '".$email."' and password = '" . md5($password) ."' ";

		$_SESSION['name'] = $row['Admin'];
...
<img src="Imagenes/Inicio/Icono.jpg" width="200" height="100" style="margin-top: 35px; margin-left: 590px;">
<img src="Imagenes/Gobierno/Logo.png" width="400" height="100" class='img' style="margin-right: 30%; margin-bottom: -60%">
<img src="Imagenes/Gobierno/Se escucha.png" width="150" height="50" style="margin-left: 85%; margin-bottom: -57%">
